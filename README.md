...
![Github Latest Release](https://img.shields.io/github/downloads/JDCalvert/fvtt-pf2e-ranged-combat/latest/total)
...
This enhancement to thrown weapons handles managing which weapons are worn, held, and dropped. A Game Master can enable or disable this system in the module settings <i>(default: disabled)</i>. This feature is currently implemented only for PCs.
...
If the weapon has a reload of 0, then the weapon stack will remain held after the attack. If the weapon has a returning rune, then the weapon will remain held after the attack and no dropped stack will be created.
